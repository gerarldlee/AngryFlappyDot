...
import com.gerarldlee.angryflappydot.sprite.Tube;
...
public class PlayState extends State {
    ...
    private com.gerarldlee.angryflappydot.sprite.Bird bird;
    private Texture bg;
    ...
    public PlayState(GameStateManager gsm) {
        super(gsm);
        bird = new com.gerarldlee.angryflappydot.sprite.Bird(50, 300);
        ...
        score = Gdx.audio.newSound(Gdx.files.internal("score.ogg"));
